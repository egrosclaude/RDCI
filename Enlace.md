...
Debido al problema de la inundación, las topologías con ciclos **están prohibidas** en las redes Ethernet. Pero aún puede utilizarse esa redundancia para obtener tolerancia a fallos gracias al protocolo de árbol de expansión o **STP**. Este protocolo está normalizdo por IEEE bajo la denominación **802.1d**.
